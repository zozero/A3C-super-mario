...
# 之所以这样是为了在编程时有输入提示，在参数类里面改值没有意义。
参数 = 参数类()
...
参数解析器.add_argument("--全局步数", type=int, default=5e4, help="即5000000，10的6次方")
参数解析器.add_argument("--线程数", type=int, default=6)
参数解析器.add_argument("--保存的间隔", type=int, default=100,
...
参数解析器.add_argument("--保存的路径", type=str, default="yixunlian")
